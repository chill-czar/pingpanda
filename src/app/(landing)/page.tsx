            ...
            <div className="relative lg:row-span-2">
              ...
              >
                ...
                <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  <div className="absolute inset-x-10 bottom-0 top-10 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-gray-700 bg-gray-900 shadow-2xl">
                    <Image
              ...
              <div className="absolute inset-px rounded-lg bg-white max-lg:rounded-t-[2rem] ">
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px) ] max-lg:rounded-t-[calc(2rem+1px)] ">
                  <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                    ...
                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                      From new user signup to successfull payments, PingPanda
                      notifies you for all critical events in yout SaaS.
                    </p>
                  </div>
                ...
                <div className="pointer-events-none absolute inset-px rounded-lg shadow right-1 ring-black/5 max-lg:rounded-t-[2rem]" />
              </div>
            </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)] ">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Connect PingPanda with your exsisting workflows in minutes.
                    and call our intutive logging API form any language.
                  </p>
                </div>
                  ...
                  <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl">
                    <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                      <div className="-mb-px flex text-sm/6 font-medium text-gray-400">
                        <div className="border-b border-r border-b-white/202 border-r-white/10 bg-white/5 px-4 py-2 text-white ">
                          pingpanda.js
                        </div>
                      </div>
                    </div>
